    ...
    <div className="w-full relative h-full flex flex-col">
      <div className="flex justify-between items-center mb-6 border-b-2 border-gray-50 pb-5">
        {menuSubScreen === 'dashboard' ? (
          ...
          <div className="flex items-center gap-4"><button onClick={() => { setMenuSubScreen('dashboard'); setDocumentationSubScreen(null); setCurrentSparePartView(null); setSelectedOrderDetails(null); }} className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 font-black flex items-center justify-center shadow-sm active:scale-90 transition-all">←</button><h2 className="font-black uppercase text-[10px] tracking-widest text-gray-300">{menuSubScreen}</h2></div>
        )}
